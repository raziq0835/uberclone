  ...
  return (
    <div className="text-gray-500 bg-cover bg-center bg-[url(https://images.unsplash.com/photo-1687247361949-ac0ffc268b99?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] h-screen w-full flex flex-col">
      ...
      <form className=" px-5 py-5 bg-gray-100  mx-auto mt-2 rounded-md shadow-lg">
        <h2 className="text-3xl font-bold mb-5">User registration</h2>
        <label className="text-2xl mb-5" htmlFor="firstName">
          First Name:
        </label>
        <br />
        <input
        ...
        />
        <br />
        <label className="text-2xl mb-5" htmlFor="email">
          Email:
        </label>
        <br />
        <input
        ...
        />
        <br />
        <label className="text-2xl mb-5 focus:bg-red" htmlFor="password">
          Password:
        </label>{" "}
        <br />
        <input
        ...
        <p className="text-center mt-3">
          Don't have an captan account?{" "}
          <Link to="/captansignin" className="text-blue-600">
            Register as Captan
          </Link>
        </p>
        <p className="text-center mt-3">
