    ...
    const [userData,setUserData] = useState({
      ...
      return (
        ...
        <form className=' px-5 py-5 bg-gray-100  mx-auto mt-2 rounded-md shadow-lg'>
          ...
          <label className="text-2xl mb-5" htmlFor="firstName">First Name:</label><br/>
          <input type="text" value={userData.fullName.firstName} onChange ={(e) => handleChange(e)} id="firstName" name="firstName" required /> 
          <br />
          <label className="text-2xl mb-5" htmlFor="lastName">Email:</label><br/>
          <input type="text" value={userData.fullName.lastName} onChange ={(e) => handleChange(e)} id="lastName" name="lastName" /> 
          <br />


          <label className="text-2xl mb-5" htmlFor="email">Email:</label><br/>
          <input type="email" value={userData.email} onChange ={(e) => handleChange(e)} id="email" name="email" required /> 
          <br />
          <label className="text-2xl mb-5 focus:bg-red" htmlFor="password">Password:</label> <br/>
          <input type="password" value={userData.password} onChange={(e) => handleChange(e)} id="password" name="password" required />
          <br />
